                      ...
                      return SliverList(
                        delegate: SliverChildBuilderDelegate(
                          (BuildContext context, int index) {
                            ...
                            return _DoctorItem(
                              doctor: doctor,
                              onBook: () => context.goRouter.pushNamed(
                                'create-appointment',
                                queryParams: <String, dynamic>{
                                  'doctorId': '${doctor.hospital?.id}'
                                },
                                extra: doctor,
                              ),
                            );
...
class _DoctorItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Bounceable(
      onTap: () => context.goRouter.goNamed(
        // '${context.goRouter.location}/${doctor.id}',
        'doctor-detail',
        params: <String, String>{
          'hospitalId': '${doctor.hospital?.id}',
          'doctorId': doctor.id.toString(),
        },
        // queryParams: <String, dynamic>{'viewOnly': 'true'},
        extra: doctor,
      ),
      child: Container(
