...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(content) => "Enter ${content}";

  static String m3(name) => "Hello ${name}";

  static String m4(person) => "Hello ${person}";

  static String m5(hours) => "${hours} hours ago";

  static String m6(minutes) => "${minutes} minutes ago";

  static String m7(content) => "Please enter ${content}";

  static String m8(person) => "Chào mừng ${person}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "aborted": MessageLookupByLibrary.simpleMessage("Aborted"),
        "about_this_doctor":
            MessageLookupByLibrary.simpleMessage("About this Doctor"),
        ...
        "choose_doctor": MessageLookupByLibrary.simpleMessage("Choose doctor"),
        ...
        "contact_moli": MessageLookupByLibrary.simpleMessage("Contact Moli"),
        "create_an_account":
        ...
        "enter_otp_sent_via_your_sms": MessageLookupByLibrary.simpleMessage(
            "Enter the OTP sent via your SMS"),
        ...
        "langauge": MessageLookupByLibrary.simpleMessage("Langauge"),
        ...
        "note_for_patient":
            MessageLookupByLibrary.simpleMessage("Note for patient"),
        ...
        "password_security":
            MessageLookupByLibrary.simpleMessage("Password & Security"),
        ...
        "today_appointment":
            MessageLookupByLibrary.simpleMessage("Today appointment"),
