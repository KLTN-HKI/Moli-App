...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(days) => "${days} ngày trước";

  static String m1(selectedItem) =>
      "${selectedItem} đã xoá sẽ không thể khôi phục bạn có chắc muốn xoá?";

  static String m2(content) => "Nhập ${content}";

  static String m3(name) => "Xin chào ${name}";

  static String m4(person) => "Xin chào ${person}";

  static String m5(hours) => "${hours} giờ trước";

  static String m6(minutes) => "${minutes} phút trước";

  static String m7(content) => "Vui lòng nhập ${content}";

  static String m8(person) => "Welcome ${person}";

  final messages = _notInlinedMessages(_notInlinedMessages);
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        "aborted": MessageLookupByLibrary.simpleMessage("Bỏ qua"),
        "about_this_doctor":
            MessageLookupByLibrary.simpleMessage("Về bác sĩ này"),
        ...
        "choose_doctor": MessageLookupByLibrary.simpleMessage("Chọn bác sĩ"),
        ...
        "contact_moli": MessageLookupByLibrary.simpleMessage("Liên hệ Moli"),
        "create_an_account":
        ...
        "enter_sent_otp": MessageLookupByLibrary.simpleMessage(
            "Nhập mã OTP đã gửi qua SMS của bạn"),
        "enter_value": m2,
        ...
        "langauge": MessageLookupByLibrary.simpleMessage("Ngôn ngữ"),
        ...
        "medical_appointment":
            MessageLookupByLibrary.simpleMessage("Lịch khám"),
        ...
        "minutes_relative": m6,
        "moli": MessageLookupByLibrary.simpleMessage("Moli"),
        ...
        "note_for_patient":
            MessageLookupByLibrary.simpleMessage("Ghi chú cho bệnh nhân"),
        ...
        "schedule": MessageLookupByLibrary.simpleMessage("Lịch"),
        ...
        "terms_conditions":
            MessageLookupByLibrary.simpleMessage("Điều khoản và quy định"),
        "terms_of_service":
        ...
        "today_appointment":
            MessageLookupByLibrary.simpleMessage("Lịch hẹn hôm nay"),
